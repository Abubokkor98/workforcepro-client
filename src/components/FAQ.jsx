...
export default function FAQ() {
  ...
  const faqs = [
    { 
      ...
      answer: "WorkForce Pro includes features such as employee management, payroll processing, HR solutions, performance tracking, team collaboration, and compliance management." 
    },
    { 
      id: 2, 
      question: "Is WorkForce Pro compatible with mobile devices?", 
      answer: "Yes, WorkForce Pro is optimized for both desktop and mobile devices, offering a smooth experience on smartphones and tablets." 
    },
    { 
      id: 3, 
      question: "How secure is the data in WorkForce Pro?", 
      answer: "We use industry-standard encryption and secure cloud storage to ensure your data is safe. Our platform complies with all relevant data protection regulations." 
    },
    { 
      id: 4, 
    ...
    { 
      ...
      answer: "Our customer support team is available 24/7 via email, live chat, or phone. We also provide a comprehensive knowledge base for self-help." 
    },
  ];
        ...
        <div className="w-full max-w-xl mx-auto">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              {activeIndex === index && (
                <div className="py-4 px-6 bg-gray-100 text-text">
                  <p>{faq.answer}</p>
                </div>
              )}
            </motion.div>
